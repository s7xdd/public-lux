...
jQuery(function ($) {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        tiltContainer.addEventListener("mousemove", (e) => {
            const { width, height, top, left } = tiltContainer.getBoundingClientRect();
            const x = e.clientX - left - width / 2;
            const y = e.clientY - top - height / 2;
    
            gsap.to(tiltCard, {
                rotationY: -x / 10, // Adjust the divisor to control the tilt sensitivity
                rotationX: y / 10,
                duration: 0.3,
                ease: "power3.out"
            });
    ...
    class ProductSwiper {
        ...
        initSwiper() {
            new Swiper(this.selector, {
                ...
                speed: 1000,
                spaceBetween: 30, // Increase the gap between slides
                navigation: {
                ...
                breakpoints: {
                    0: {
                        slidesPerView: 1,
                        spaceBetween: 20, // Smaller gap for smaller screens
                    },
                    600: {
                        slidesPerView: 2,
                        spaceBetween: 25,
                    ...
                    1200: {
                        slidesPerView: 4,
                        spaceBetween: 40, // Larger gap for larger screens
                    },
                },
            });
        }
    ...
    $(document).ready(function() {
        new ProductSwiper('.product-swiper');
    });
                ...
                jQuery('.swiper').each(function() {
                    ...
                    if ( $this.hasClass('bringer-carousel') ) {
                        ...
                        options.breakpoints = {
                            ...
                            1200: {
                                // Desktop
                                slidesPerView: $this.attr('data-count') !== undefined ? parseFloat($this.attr('data-count')) : 4,
